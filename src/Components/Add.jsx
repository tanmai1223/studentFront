      ...
      <div className="main-contented">
        <section className="details-sectioned">
          ...
          <form onSubmit={handleSubmit}>
            <p><strong>Name:</strong> <input type="text" name="name" value={info.name} onChange={handleChange} required /></p>
            <p><strong>Roll No:</strong> <input type="text" name="rollno" value={info.rollno} onChange={handleChange} required /></p>
            <p><strong>Email:</strong> <input type="text" name="gmail" value={info.gmail} onChange={handleChange} required /></p>
